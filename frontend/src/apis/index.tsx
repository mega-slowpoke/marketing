...
export const strategyArmory = (strategyId?: number) => {
    return fetch(`${apiHostUrl}/api/v1/raffle/initialize_strategy?strategyId=${strategyId}`, {
        method: 'GET',
        headers: {
...
export const queryRaffleAwardList = (strategyId?: number) => {
    try {
        return fetch(`${apiHostUrl}/api/v1/raffle/query_award_list`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json'
            },
...
export const randomRaffle = (strategyId?: number) => {
    try {
        return fetch(`${apiHostUrl}/api/v1/raffle/lottery`, {
            method: 'POST',
            headers: {

...
CREATE TABLE `strategy_award` (
                                  ...
                                  `award_total` int(8) NOT NULL DEFAULT '0' COMMENT '奖品库存总量',
                                  `award_remaining` int(8) NOT NULL DEFAULT '0' COMMENT '奖品库存剩余',
...
INSERT INTO `strategy_award` (`id`, `strategy_id`, `award_id`, `award_title`, `award_subtitle`, `award_total`, `award_remaining`, `award_rate`, `rule_model`, `sort_order`, `create_time`, `update_time`)
VALUES
